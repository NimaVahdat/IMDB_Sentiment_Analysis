...
imdb_rnn.visualize()
```
<img src="visual/positive_word_cloud.png" alt="Positive Reviews Word Cloud" width="45%"/> <img src="visual/negative_word_cloud.png" alt="Negative Reviews Word Cloud" width="45%"/>
